            ...
            if (preg_match($pattern, $explode_nombre_archivo[0], $match)) {
                ...
                if (($handle = fopen($path.$archivo_escogido, "r")) !== FALSE) {
                    ...
                    if ((count($campos) != 15)){
                        ...
                        $error = '<br>Error en archivo de catálogo '.$archivo_escogido.' . Error en número de columnas, no coincide, deberían ser 15 y son '.count($campos); 
                        $output = '<div class="panel">'.$error.'</div>';
            ...
            if (preg_match($pattern, $explode_nombre_archivo[0], $match)) {
                ...
                if (($handle = fopen($path.$archivo_escogido, "r")) !== FALSE) {
                    ...
                    if ((count($campos) != 32)){
                        ...
                        $error = '<br>Error en archivo de catálogo '.$archivo_escogido.' . Error en número de columnas, no coincide, deberían ser 32 y son '.count($campos); 
                        $output = '<div class="panel">'.$error.'</div>';
                    ...
                    while (($campos = fgetcsv($handle, 0, ";")) !== FALSE) {                        
                        ...
                        $url_imagen = trim($campos[28]);
                        if (!$url_imagen || $url_imagen == '' || is_null($url_imagen)){
                            $url_imagen = '';
                        }

                        $url_imagen_2 = trim($campos[29]);
                        if (!$url_imagen_2 || $url_imagen_2 == '' || is_null($url_imagen_2)){
                            $url_imagen_2 = '';
                        }

                        $url_imagen_3 = trim($campos[30]);
                        if (!$url_imagen_3 || $url_imagen_3 == '' || is_null($url_imagen_3)){
                            $url_imagen_3 = '';
                        }

                        $url_imagen_4 = trim($campos[31]);
                        if (!$url_imagen_4 || $url_imagen_4 == '' || is_null($url_imagen_4)){
                            $url_imagen_4 = '';
                        }
